...
import (
	...
	"github.com/habibiazmi123/go-grpc-order-svc/pkg/client"
	"github.com/habibiazmi123/go-grpc-order-svc/pkg/db"
	"github.com/habibiazmi123/go-grpc-order-svc/pkg/models"
	"github.com/habibiazmi123/go-grpc-order-svc/pkg/pb"
)
...
func (s *Server) CreateOrder(ctx context.Context, req *pb.CreateOrderRequest) (*pb.CreateOrderResponse, error) {
	...
	if err != nil {
		...
		return &pb.CreateOrderResponse{Status: http.StatusConflict, Error: "Stock to less"}, nil
	}
